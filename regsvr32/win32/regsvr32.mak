...
#
#  $Id: regsvr32.mak 1 2014-02-06 21:56:41Z rhubarb-geek-nz $
...
$(INTDIR)\$(APPNAME).obj: ..\src\$(APPNAME).c $(INTDIR)
	$(CC) /c $(STDOPT) $(CC_OUT_OBJ)$@ ..\src\$(APPNAME).c $(CC_OUT_PDB)$(TARGET_PDB)

$(INTDIR):
	mkdir $@

$(INTDIR)\$(APPNAME).res: ..\win32\$(APPNAME).rc
	rc /r $(RCFLAGS) /I.. /I..\..\include\$(PLATFORM) /fo$@ ..\win32\$(APPNAME).rc
