...
#
#  $Id: chown.mak 1 2014-02-06 21:56:41Z rhubarb-geek-nz $
...
OBJS=$(INTDIR)\$(APPNAME).obj $(INTDIR)\link386.obj $(INTDIR)\winerror.obj
...
$(TARGET_EXE): $(OBJS) $(OUTDIR) $(INTDIR)\$(APPNAME).res
	$(CC) $(CC_OUT_EXE)$@ $(OBJS)				\
			$(CC_OUT_PDB)$(TARGET_PDB)			\
			$(CC_LINK) $(LD_SUBSYSTEM_CONSOLE) $(LDFLAGS) $(INTDIR)\$(APPNAME).res
	$(POSTLINK_EXE) $@
