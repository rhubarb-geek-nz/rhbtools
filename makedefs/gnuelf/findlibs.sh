...
then
	HAVE_LIBUSB1=true
	MAKEDEFS_DEFS="$MAKEDEFS_DEFS USB1LIBS"
fi
...
MAKEDEFS_DEFS="$MAKEDEFS_DEFS HAVE_LIBUSB HAVE_LIBPCSC HAVE_LIBEXPAT HAVE_LIBX11 HAVE_LIBUUID HAVE_LIBCURL HAVE_LIBXT HAVE_LIBXM HAVE_LIBCRYPTO HAVE_LIBSSL HAVE_LIBUSB1 HAVE_LIBXML"
