...
MAKEDEFS_DEFS="$MAKEDEFS_DEFS HAVE_LIBUSB HAVE_LIBPCSC HAVE_LIBUUID HAVE_LIBX11 HAVE_LIBEXPAT HAVE_LIBSSL HAVE_LIBCRYPTO HAVE_LIBXT HAVE_LIBXM HAVE_LIBCURL"
