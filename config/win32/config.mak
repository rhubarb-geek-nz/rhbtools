...
HOSTDIR_CONFIG_EXE=$(RHBTOOLS_BIN)\config.exe
# HOSTDIR_CONFIG_EXE=$(CONFIG_EXE)

all: checkenv $(OUTDIR_TOOLS) $(INTDIR) $(CONFIG_EXE) $(CONFIG_I) $(CONFIG_HPP)
...
$(INTDIR)\$(APPNAME).res: ..\win32\$(APPNAME).rc
	rc $(RCFLAGS) /r /I.. /I..\..\include\$(PLATFORM) /fo$@ ..\win32\$(APPNAME).rc
