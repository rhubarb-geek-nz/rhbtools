...
#
#  $Id: config.mak 1 2014-02-06 21:56:41Z rhubarb-geek-nz $
...
$(CONFIG_H): $(CONFIG2_SH) $(CONFIG2_C)
	...
	$(CFLAGS) $(CONFIG_CFLAGS) $(STDOPT) $(STDINCL) $(XMLIBS) $(XTLIBS) $(X11LIBS) $(PCSCLIBS) $(USB1LIBS) $(UUIDLIBS) $(CFLIBS) $(ATLIBS) $(SSLLIBS) $(CRYPTOLIBS) $(SOCKLIBS) $(STDLIB) $(CONFIG_TAIL)
...
$(CONFIG_HPP): $(CONFIG2_SH) $(CONFIG2_CPP)
	...
	CC="$(CXX)" \
	"$(CONFIG2_SH)" $(CONFIG_HEAD) \
	$(CXXFLAGS) $(CONFIG_CXXFLAGS) $(STDOPTXX) $(STDINCL) $(XMLIBS) $(XTLIBS) $(X11LIBS) $(PCSCLIBS) $(USB1LIBS) $(UUIDLIBS) $(CFLIBS) $(ATLIBS) $(SSLLIBS) $(CRYPTOLIBS) $(SOCKLIBS) $(STDLIBXX) $(CONFIG_TAIL)
