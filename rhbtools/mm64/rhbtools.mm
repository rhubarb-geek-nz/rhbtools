...
<$DirectoryTree Key="INSTALLDIR" Dir="[ProgramFiles64Folder]rhubarb.geek.nz\RHBtools" CHANGE="\" PrimaryFolder="Y">
...
<$DirectoryTree Key="INSTALLDIR5" Dir="[INSTALLDIR]src" >
	...
	<$Files "..\tools\regsvr64.exe" DestDir="INSTALLDIR1" >
	...
	<$Files "src\regsvr64.c" DestDir="INSTALLDIR5" >
