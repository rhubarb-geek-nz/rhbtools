...
#  $Id: find.mak 1 2014-02-06 21:56:41Z rhubarb-geek-nz $
...
OBJS=$(INTDIR)\$(APPNAME).obj $(INTDIR)\dirent.obj
...
$(INTDIR)\dirent.obj: ..\..\dirent\src\dirent.c $(INTDIR)
	$(CC) /c $(PARTOPTS) $(CC_OUT_OBJ)$@ ..\..\dirent\src\dirent.c
